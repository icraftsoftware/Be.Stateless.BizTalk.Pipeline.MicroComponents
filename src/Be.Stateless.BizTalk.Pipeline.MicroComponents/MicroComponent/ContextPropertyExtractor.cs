...
#pragma warning disable CS1574
	...
	/// </item>
	/// <item>
	/// <see href="http://bloggingabout.net/blogs/wellink/archive/2006/03/03/11207.aspx">XpathMutatorStream: Great functionality
	/// for every BizTalk Developer.</see>
	/// </item>
	/// <item>
	...
	/// </item>
	/// <item>
	/// <see href="http://msdn.microsoft.com/en-us/library/ms950778.aspx">The Best of Both Worlds: Combining XPath with the XmlReader</see>
	/// </item>
	/// </list>
	/// </para>
	/// <para>
	...
	/// cref="ReactiveXPathExtractorCollection.OnMatch">ReactiveXPathExtractorCollection.OnMatch</see> method. Given the
	...
	/// is using an <see cref="System.Xml.XPath.XPathNavigator"/> in combination with a <see cref="VirtualStream"/>. That would
...
#pragma warning restore CS1574
	public class ContextPropertyExtractor : IMicroComponent
	{
		...
		internal IEnumerable<PropertyExtractor> BuildPropertyExtractorCollection(IPipelineContext pipelineContext, IBaseMessage message)
		{
			...
			return schemaMetadata.GetPropertyExtractors().Union(Extractors);
		}
	}
}
