...
namespace Be.Stateless.BizTalk.Unit.MicroComponent
{
	...
	[SuppressMessage("ReSharper", "UnusedTypeParameter", Justification = "Public API constraint.")]
	public abstract class MicroComponentFixtureBase<T> where T : IMicroComponent
	{
